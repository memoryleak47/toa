        ...
        match e {
            ...
            Event::MouseButtonReleased {
                ...
                if self.window_grab.is_some() {
                    ...
                    println!("warning: window_grab is None but middle mouse button was pressed");
                }
            }
            Event::MouseButtonReleased { button: b, x, y } => {
                self.handle_mouse_press((x as f32, y as f32).into(), b)
            }
